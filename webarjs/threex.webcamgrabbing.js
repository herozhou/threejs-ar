/**
 * Created by HeroZhou on 2017/4/4.
 */
var THREEx = THREEx || {}
 ...
 * Grab camera
 * @constructor
 * THREEX 已经封装好库  只需要添加一个视频标签 在调用摄像头  返回一个值就行  不用在设置其他东西就可以设置全屏幕的AR
 *
 */
 ...
 console.log('videoAspect <<<<< windowAspect')
    ...
    MediaStreamTrack.getSources(function(sourceInfos) {
        ...
        var constraints = {
            video: {
                autofocus:true,
                width: { min: 1280, ideal: 1280, max: 1920 },  //设置最小分辨率   理想分辨率  与最大分辨率
                height: { min: 720, ideal: 720, max: 1080 } //设置最小分辨率   理想分辨率  与最大分辨率
            },
            audio: false
